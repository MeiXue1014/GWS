...
public class ComingSoon extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mcImage1.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        mcImage2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                openComingSoon2();
            }
        ...
        mcImage3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                openComingSoon3();
            }
        ...
        mcImage4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                openComingSoon4();
            }
        ...
        mcImage5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                openComingSoon5();
            }
        ...
        mcImage6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                openComingSoon6();
            }
        ...
        mcImage7.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                openComingSoon7();
            }
        ...
        mcImage8.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                openComingSoon8();
            }
        ...
        mcImage9.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                openComingSoon9();
            }
        ...
        mcImage10.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                openComingSoon10();
            }
        ...
        mcImage11.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                openComingSoon11();
            }
        ...
        mcImage12.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                openComingSoon12();
            }
        ...
        mcImage13.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                openComingSoon13();
            }
    ...
    public void openComingSoon1(){
        Intent intent = new Intent(this, ComingSoon1Activity.class);
        startActivity(intent);
    }

    public void openComingSoon2(){
        Intent intent = new Intent(this, ComingSoon2Activity.class);
        startActivity(intent);
    }

    public void openComingSoon3(){
        Intent intent = new Intent(this, ComingSoon3Activity.class);
        startActivity(intent);
    }

    public void openComingSoon4(){
        Intent intent = new Intent(this, ComingSoon4Activity.class);
        startActivity(intent);
    }

    public void openComingSoon5(){
        Intent intent = new Intent(this, ComingSoon5Activity.class);
        startActivity(intent);
    }

    public void openComingSoon6(){
        Intent intent = new Intent(this, ComingSoon6Activity.class);
        startActivity(intent);
    }

    public void openComingSoon7(){
        Intent intent = new Intent(this, ComingSoon7Activity.class);
        startActivity(intent);
    }

    public void openComingSoon8(){
        Intent intent = new Intent(this, ComingSoon8Activity.class);
        startActivity(intent);
    }

    public void openComingSoon9(){
        Intent intent = new Intent(this, ComingSoon9Activity.class);
        startActivity(intent);
    }

    public void openComingSoon10(){
        Intent intent = new Intent(this, ComingSoon10Activity.class);
        startActivity(intent);
    }

    public void openComingSoon11(){
        Intent intent = new Intent(this, ComingSoon11Activity.class);
        startActivity(intent);
    }

    public void openComingSoon12(){
        Intent intent = new Intent(this, ComingSoon12Activity.class);
        startActivity(intent);
    }

    public void openComingSoon13(){
        Intent intent = new Intent(this, ComingSoon13Activity.class);
        startActivity(intent);
    }
}