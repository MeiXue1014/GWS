    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId())
        {
            ...
            case R.id.experiences:
                intent = new Intent( Policy.this,Experience.class);
                startActivity(intent);
                break;
            case R.id.showtime:
                intent = new Intent( Policy.this,SelectMovie.class);
                startActivity(intent);
                break;
            case R.id.nav_popular:
                intent = new Intent( Policy.this,Popular.class);
                startActivity(intent);
                break;
            case R.id.nav_now_showing:
                intent = new Intent( Policy.this,NowShowing.class);
                startActivity(intent);
                break;
            case R.id.nav_coming_soon:
                intent = new Intent( Policy.this,ComingSoon.class);
                startActivity(intent);
                break;
            case R.id.nav_editAccount:
                intent = new Intent( Policy.this,MainActivity.class);
                startActivity(intent);
                break;
        }
