...
public class Popular extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mpImage1.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        mpImage2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                openNowShowing11();
            }
        ...
        mpImage3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                openNowShowing8();
            }
        ...
        mpImage4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                openNowShowing10();
            }
        ...
        mpImage5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                openNowShowing4();
            }
        ...
        mpImage6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                openNowShowing7();
            }
        ...
        mpImage7.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                openNowShowing12();
            }
        ...
        mpImage8.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                openNowShowing13();
            }
