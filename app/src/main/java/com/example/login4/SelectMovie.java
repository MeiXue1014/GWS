...
public class SelectMovie extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        {
            case R.id.nav_home:
                intent = new Intent( SelectMovie.this,Home.class);
                startActivity(intent);
                break;
            case R.id.nav_faq:
                intent = new Intent( SelectMovie.this,Faq.class);
                startActivity(intent);
                break;
            case R.id.nav_policy:
                intent = new Intent(SelectMovie.this, Policy.class);
                startActivity(intent);
                break;
            case R.id.experiences:
                intent = new Intent( SelectMovie.this,Experience.class);
                startActivity(intent);
                break;
            case R.id.showtime:
                intent = new Intent( SelectMovie.this,SelectMovie.class);
                startActivity(intent);
                break;
            case R.id.nav_popular:
                intent = new Intent( SelectMovie.this,Popular.class);
                startActivity(intent);
                break;
            case R.id.nav_now_showing:
                intent = new Intent( SelectMovie.this,NowShowing.class);
                startActivity(intent);
                break;
            case R.id.nav_coming_soon:
                intent = new Intent( SelectMovie.this,ComingSoon.class);
                startActivity(intent);
                break;
            case R.id.nav_editAccount:
                intent = new Intent( SelectMovie.this,MainActivity.class);
                startActivity(intent);
                break;
        }
    ...
    public void buy1 (View view){
        ...
        Intent intent = new Intent(SelectMovie.this, ShowTime.class);
        intent.putExtra(EXTRA_MESSAGE, msName1.getText().toString());
        startActivity(intent);
    }
    ...
    public void buy2 (View view){
        Log.d(LOG_TAG, "Button clicked!");
        Intent intent = new Intent(SelectMovie.this, ShowTime.class);
        intent.putExtra(EXTRA_MESSAGE, msName2.getText().toString());
        startActivity(intent);
    }
    ...
    public void buy3 (View view){
        Log.d(LOG_TAG, "Button clicked!");
        Intent intent = new Intent(SelectMovie.this, ShowTime.class);
        intent.putExtra(EXTRA_MESSAGE, msName3.getText().toString());
        startActivity(intent);
    }
    ...
    public void buy4 (View view){
        Log.d(LOG_TAG, "Button clicked!");
        Intent intent = new Intent(SelectMovie.this, ShowTime.class);
        intent.putExtra(EXTRA_MESSAGE, msName4.getText().toString());
        startActivity(intent);
    }
    ...
    public void buy5 (View view){
        Log.d(LOG_TAG, "Button clicked!");
        Intent intent = new Intent(SelectMovie.this, ShowTime.class);
        intent.putExtra(EXTRA_MESSAGE, msName5.getText().toString());
        startActivity(intent);
    }
    ...
    public void buy6 (View view){
        Log.d(LOG_TAG, "Button clicked!");
        Intent intent = new Intent(SelectMovie.this, ShowTime.class);
        intent.putExtra(EXTRA_MESSAGE, msName6.getText().toString());
        startActivity(intent);
    }
    ...
    public void buy7 (View view){
        Log.d(LOG_TAG, "Button clicked!");
        Intent intent = new Intent(SelectMovie.this, ShowTime.class);
        intent.putExtra(EXTRA_MESSAGE, msName7.getText().toString());
        startActivity(intent);
    }
    ...
    public void buy8 (View view){
        Log.d(LOG_TAG, "Button clicked!");
        Intent intent = new Intent(SelectMovie.this, ShowTime.class);
        intent.putExtra(EXTRA_MESSAGE, msName8.getText().toString());
        startActivity(intent);
    }
    ...
    public void buy9 (View view){
        Log.d(LOG_TAG, "Button clicked!");
        Intent intent = new Intent(SelectMovie.this, ShowTime.class);
        intent.putExtra(EXTRA_MESSAGE, msName9.getText().toString());
        startActivity(intent);
    }
    ...
    public void buy10 (View view){
        Log.d(LOG_TAG, "Button clicked!");
        Intent intent = new Intent(SelectMovie.this, ShowTime.class);
        intent.putExtra(EXTRA_MESSAGE, msName10.getText().toString());
        startActivity(intent);
    }
    ...
    public void buy11 (View view){
        Log.d(LOG_TAG, "Button clicked!");
        Intent intent = new Intent(SelectMovie.this, ShowTime.class);
        intent.putExtra(EXTRA_MESSAGE, msName11.getText().toString());
        startActivity(intent);
    }
    ...
    public void buy12 (View view){
        Log.d(LOG_TAG, "Button clicked!");
        Intent intent = new Intent(SelectMovie.this, ShowTime.class);
        intent.putExtra(EXTRA_MESSAGE, msName12.getText().toString());
        startActivity(intent);
    }
    ...
    public void buy13 (View view){
        Log.d(LOG_TAG, "Button clicked!");
        Intent intent = new Intent(SelectMovie.this, ShowTime.class);
        intent.putExtra(EXTRA_MESSAGE, msName13.getText().toString());
        startActivity(intent);
    }
    ...
    public void buy14 (View view){
        Log.d(LOG_TAG, "Button clicked!");
        Intent intent = new Intent(SelectMovie.this, ShowTime.class);
        intent.putExtra(EXTRA_MESSAGE, msName14.getText().toString());
        startActivity(intent);
    }
    ...
    public void buy15 (View view){
        Log.d(LOG_TAG, "Button clicked!");
        Intent intent = new Intent(SelectMovie.this, ShowTime.class);
        intent.putExtra(EXTRA_MESSAGE, msName15.getText().toString());
        startActivity(intent);
    }
    ...
    public void buy16 (View view){
        Log.d(LOG_TAG, "Button clicked!");
        Intent intent = new Intent(SelectMovie.this, ShowTime.class);
        intent.putExtra(EXTRA_MESSAGE, msName16.getText().toString());
        startActivity(intent);
    }
    ...
    public void buy17 (View view){
        Log.d(LOG_TAG, "Button clicked!");
        Intent intent = new Intent(SelectMovie.this, ShowTime.class);
        intent.putExtra(EXTRA_MESSAGE, msName17.getText().toString());
        startActivity(intent);
    }
}