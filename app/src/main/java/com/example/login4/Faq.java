...
public class Faq extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public void FB(View view) {
        Log.d(LOG_TAG, "Button clicked!");
        Intent intent = new Intent(Faq.this, Food.class);
        startActivity(intent);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId())
        {
            ...
            case R.id.experiences:
                intent = new Intent( Faq.this,Experience.class);
                startActivity(intent);
                break;
            case R.id.showtime:
                intent = new Intent( Faq.this,SelectMovie.class);
                startActivity(intent);
                break;
            case R.id.nav_popular:
                intent = new Intent( Faq.this,Popular.class);
                startActivity(intent);
                break;
            case R.id.nav_now_showing:
                intent = new Intent( Faq.this,NowShowing.class);
                startActivity(intent);
                break;
            case R.id.nav_coming_soon:
                intent = new Intent( Faq.this,ComingSoon.class);
                startActivity(intent);
                break;
