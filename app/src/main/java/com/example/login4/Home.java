...
public class Home extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId())
        {
            ...
            case R.id.nav_policy:
                intent = new Intent(Home.this, Policy.class);
                startActivity(intent);
                break;
            case R.id.experiences:
                intent = new Intent( Home.this,Experience.class);
                startActivity(intent);
                break;
            case R.id.showtime:
                intent = new Intent( Home.this,SelectMovie.class);
                startActivity(intent);
                break;
            case R.id.nav_popular:
                intent = new Intent( Home.this,Popular.class);
                startActivity(intent);
                break;
            case R.id.nav_now_showing:
                intent = new Intent( Home.this,NowShowing.class);
                startActivity(intent);
                break;
            case R.id.nav_coming_soon:
                intent = new Intent( Home.this,ComingSoon.class);
                startActivity(intent);
                break;
    ...
    public void rActivityNowShowing (View view){
        Intent intent = new Intent(Home.this, NowShowing.class);
        startActivity(intent);
    }

    public void rActivityComingSoon (View view){
        Intent intent = new Intent(Home.this, ComingSoon.class);
        startActivity(intent);
    }
